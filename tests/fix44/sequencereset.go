...
func makeSequenceReset() *SequenceReset {
	msg := &SequenceReset{
		Message: fix.NewMessage(FieldBeginString, FieldBodyLength, FieldCheckSum, FieldMsgType, beginString, MsgTypeSequenceReset).
			SetBody(
				fix.NewKeyValue(FieldGapFillFlag, &fix.Bool{}),
...
func NewSequenceReset() *SequenceReset {
	...
	return &SequenceReset{
		fix.NewMessage(FieldBeginString, FieldBodyLength, FieldCheckSum, FieldMsgType, beginString, MsgTypeSequenceReset).
			SetBody(m.Body()...).
...
func (sequenceReset *SequenceReset) SetFieldGapFillFlag(gapFillFlag bool) messages.SequenceResetBuilder {
	return sequenceReset.SetGapFillFlag(gapFillFlag)
}
