	...
	msg := &MarketDataRequest{
		Message: fix.NewMessage(FieldBeginString, FieldBodyLength, FieldCheckSum, FieldMsgType, beginString, MsgTypeMarketDataRequest).
			SetBody(
				...
				fix.NewKeyValue(FieldMDImplicitDelete, &fix.Bool{}),
...
func NewMarketDataRequest() *MarketDataRequest {
	...
	return &MarketDataRequest{
		fix.NewMessage(FieldBeginString, FieldBodyLength, FieldCheckSum, FieldMsgType, beginString, MsgTypeMarketDataRequest).
			SetBody(m.Body()...).
...
func (MarketDataRequest) New() messages.MarketDataRequestBuilder {
	return makeMarketDataRequest()
}

// Build provides an opportunity to customize message during building outgoing message
func (MarketDataRequest) Build() messages.MarketDataRequestBuilder {
	return makeMarketDataRequest()
}
